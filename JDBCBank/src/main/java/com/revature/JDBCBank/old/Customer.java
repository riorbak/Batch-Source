...
public class Customer implements Serializable
{
	...
	//apply for base account (if isJoint == false)
		...
		if (a != null)
		{
			...
			{				
				...
				System.out.println("Deposited $" + dep +" into Account Num "
						+ a.getAccountNum() + "."
						+ "Current Balance: $" + a.getAccountBalance() + "." );					
			}
			while(gettingInput);
		}
		else
			System.out.println("Unable to deposit at this time.");
	}
	...
	public void withdraw(Account a)
	{
		...
		if(a != null)
		{
			...
			System.out.println("Unable to withdraw at this time.");
	}	
	...
	{
		ArrayList<Account> eligible = new ArrayList<>();
		...
		{			
			...
			if(!eligible.isEmpty())
			{
				System.out.println("Accounts eligible for closing: ");
				for (Account a : eligible)
				{
					System.out.println(a.getAccountNum());
				}
			}
			else 
				System.out.print("No accounts eligible for closing." + 
